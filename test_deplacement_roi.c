...
int roi( int x, int y, int *deplacement)
{
	...
	if(plateau[y][x].piece[1] == *blanc)
	{
		...
		//avant gauche
		if((x-1 >= 0) && (y-1 >= 0) && (strcmp(plateau[x-1][y-1].piece, "00") == 0 || plateau[x-1][y-1].piece[1] == *noir))
		{
			deplacement[j] = y-1;
			j++;
			deplacement[j] = x-1;
		...
		//avant
		if((x-1 >= 0) && (y < 8) && (strcmp(plateau[x-1][y].piece, "00") == 0 || plateau[x-1][y].piece[1] == *noir))
		{
			deplacement[j] = y;
			j++;
			deplacement[j] = x-1;
		...
		//avant droite
		if((x-1 >=0) && (y+1 < 8) && (strcmp(plateau[x-1][y+1].piece,"00") == 0 || plateau[x-1][y+1].piece[1] == *noir))
		{
			deplacement[j] = y+1;
			j++;
			deplacement[j] = x-1;
	...
	if(plateau[y][x].piece[1] == *noir)
	{
		...
		//arriere gauche
		if((x+1 < 8) && (y-1 >= 0) && (strcmp(plateau[x+1][y-1].piece, "00") == 0 || plateau[x+1][y-1].piece[1] == *blanc))
		{
			deplacement[j] = y-1;
			j++;
			deplacement[j] = x+1;
		...
		//gauche
		if((x < 8) && (y-1 >=0) && (strcmp(plateau[x][y-1].piece, "00") == 0 || plateau[x][y-1].piece[1] == *blanc))
		{
			deplacement[j] = y-1;
			j++;
			deplacement[j] = x;
		...
		//avant gauche
		if((x-1 >= 0) && (y-1 >=0) && (strcmp(plateau[x-1][y-1].piece, "00") == 0 || plateau[x-1][y-1].piece[1] == *blanc))
		{
			deplacement[j] = y-1;
			j++;
			deplacement[j] = x-1;
		...
		//avant
		if((x-1 >= 0) && (y < 8) && (strcmp(plateau[x-1][y].piece, "00") == 0 || plateau[x-1][y].piece[1] == *blanc))
		{
			deplacement[j] = y;
			j++;
			deplacement[j] = x-1;
		...
		//avant droite
		if((x-1 >=0) && (y+1 < 8) && (strcmp(plateau[x-1][y+1].piece,"00") == 0 || plateau[x-1][y+1].piece[1] == *blanc))
		{
			deplacement[j] = y+1;
			j++;
			deplacement[j] = x-1;
